...
namespace WindowsFormsApplication23 {
    ...
    public partial class DataSet6 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable1Row AddDataTable1Row(string Name, string Contact, string Email, int Designation, decimal Salary, int GroupId, string Title, string Advisor_Role) {
            ...
            private void InitClass() {
                ...
                this.columnAdvisor_Id.AutoIncrementSeed = -1;
                this.columnAdvisor_Id.AutoIncrementStep = -1;
                ...
                this.columnAdvisor_Role.AllowDBNull = false;
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public int Advisor_Id {
                get {
                    return ((int)(this[this.tableDataTable1.Advisor_IdColumn]));
                }
                set {
                    this[this.tableDataTable1.Advisor_IdColumn] = value;
                }
            }
            ...
            public int Designation {
                get {
                    return ((int)(this[this.tableDataTable1.DesignationColumn]));
                }
                set {
...
namespace WindowsFormsApplication23.DataSet6TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        Person.Id AS Advisor_Id, Person.FirstName + ' ' + Person.LastName AS Name, Person.Contact, Person.Email, Advisor.Designation, Advisor.Salary, GroupProject.GroupId, Project.Title, Lookup.Value AS Advisor_Role
FROM            Advisor INNER JOIN
                         ProjectAdvisor ON Advisor.Id = ProjectAdvisor.AdvisorId INNER JOIN
                         Person ON ProjectAdvisor.AdvisorId = Person.Id INNER JOIN
                         GroupProject ON GroupProject.ProjectId = ProjectAdvisor.ProjectId INNER JOIN
                         Project ON Project.Id = ProjectAdvisor.ProjectId INNER JOIN
                         Lookup ON Lookup.Id = ProjectAdvisor.AdvisorRole";
        ...
        public virtual int Fill(DataSet6.DataTable1DataTable dataTable) {
        ...
        public virtual DataSet6.DataTable1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
